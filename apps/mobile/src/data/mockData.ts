// Ported 1:1 from apps/web/src/data/mockData.js — keep both in sync.
...
export const SEED_ACCOUNTS = [
  { id: acc1, name: 'HDFC Savings', type: 'bank', owner: u1, balance: 185000, currency: 'INR' },
  { id: acc2, name: 'SBI Credit Card', type: 'credit_card', owner: u1, balance: -12400, currency: 'INR' },
  { id: acc3, name: 'Cash', type: 'cash', owner: u2, balance: 8500, currency: 'INR' },
];
...
export const SEED_ASSETS = [
  ...
  { id: 'asset-fd-001', name: 'SBI Fixed Deposit', type: 'fd', quantity: 1, unit: null, avgPrice: 200000, currentPrice: 218000, owner: u1 },
];

export const SEED_LIABILITIES = [
  { id: 'lib-home-001', name: 'Home Loan', type: 'home_loan', principal: 4500000, interestRate: 8.5, tenureMonths: 240, emi: 39165, startDate: '2022-01-01', outstanding: 4120000 },
...
export const SEED_INSURANCE = [
  { id: 'ins-001', name: 'LIC Term Plan', type: 'term', policyNo: 'LIC-12345', premium: 18000, frequency: 'yearly', sumAssured: 10000000, nextDue: '2027-01-15', owner: u1 },
  { id: 'ins-002', name: 'Star Health Family', type: 'health', policyNo: 'SH-98765', premium: 24000, frequency: 'yearly', sumAssured: 1000000, nextDue: '2026-08-10', owner: u1 },
];
